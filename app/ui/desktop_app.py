...
class FemagDesktopWindow(QMainWindow):
    ...
    def _open_manual_debit_dialog(self, preset_client=None) -> None:
        try:
            ...
            QMessageBox.warning(
                self, "Débito manual", f"No se pudo abrir el formulario: {exc}"
            )
            return
    ...
    def _dashboard_page(self) -> QWidget:
        ...
        page.layout().setContentsMargins(18, 12, 18, 18)
